...
var creatDiv = function(parentElement,attr,contentHtm) { // attr is "id" OR "array" // {id:'divId',style:'styleDiv',className:'lassDiv'}

	alert("Depreciated use : getTpl('div', {id:'myDiv'} ));");
...
var showHideBoxes = function(v) { // visibility = hidden|visible
	$$('select', 'iframe').invoke((v == 'hidden' || v == 'hide' ? 'hide' : 'show')); //, 'embed', 'object'
};

// -------------------- AJAX VALID INPUT -------------------- //
//var isWorking = false;
var ajaxCheck = function (input, valeur, divInfo) {
	//if (!isWorking) {
