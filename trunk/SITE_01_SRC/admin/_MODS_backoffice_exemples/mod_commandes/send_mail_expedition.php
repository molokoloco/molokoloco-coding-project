...
if ($commande_id > 0) {
	...
	if ($mailok != 2 && !$noExp) {
		...
		// FETCH ALERTE EMAIL
		$P =& new Q("SELECT * FROM dat_email_alertes WHERE id='5' LIMIT 1 ");
		...
		$Q =& new Q("UPDATE mod_commandes SET mailok='2', statut_c='3' WHERE id='$commande_id' ");
...
if ($noExp){ ?>
	...
	<b>L'email a d&eacute;j&agrave; &eacute;t&eacute; envoy&eacute; voulez vous le <a href="send_mail.php?id=<?=$commande_id;?>&mailok=2">r&eacute;-envoyer</a> ? </b><? 
} else { ?>
