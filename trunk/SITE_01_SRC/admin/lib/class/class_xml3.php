...
include("xml/phpxml/xml.php");
            
// Create an XML object for the XML file.
//$xml = new XML('./'.$_SESSION['MEMBRE']['url'].'/tags_list2.xml');
//$government = $xml->evaluate("//mot/*[contains(., train)]/..");
//$government =& $xml->evaluate("//mot");
//db($xml->get_content($government[0]."/titre[1]"));
