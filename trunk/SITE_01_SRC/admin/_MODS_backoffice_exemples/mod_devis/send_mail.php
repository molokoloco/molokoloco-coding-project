...
if ($devis_id > 0) {
	...
	if ($mailok != '1') {
		...
		// FETCH ALERTE EMAIL
		$P =& new Q("SELECT * FROM dat_email_alertes WHERE id='6' LIMIT 1 ");
		...
		$Q =& new Q("UPDATE mod_devis SET mailok='1' WHERE id='$devis_id' ");
...
<td align="center"><? if (!$ok) { ?>
	<b>L</b><b>'email a d&eacute;j&agrave; &eacute;t&eacute; envoy&eacute; voulez vous le <a href="send_mail.php?id=<?=$devis_id;?>&mailok=1">r&eacute;-envoyer</a> ? </b><? 
} else { ?>
